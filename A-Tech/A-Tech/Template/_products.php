...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="./images/Laptop/laptop_asus_2in1_1.png" alt="product" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    <tr class="font-rale font-size-14">
                        <td>M.R.P:</td>
                        <td><strike>$889.00</strike></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Deal Price:</td>
                        <td class="font-size-20 text-danger">$<span>819.00</span><small
                                class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">$70.00</span></td>
                    </tr>
                </table>
                <!-- !product price -->
            ...
            <div class="col-12">
                ...
                <hr>
                <p><b>Processor</b>: Intel Core I5-1135G7 max frequency 4.2 GHz</p>
                <p><b>Resolution</b>: 2880 x 1800</p>
                <p><b>RAM</b>: 8 Gb</p>
                <p><b>Screen Size</b> : 14 inches</p>
                <p><b>Storage:</b>: SSD 512 Gb</p>
                <p><b>Video Card</b> : Intel Iris Xe</p>
                <p><b>Operating System</b> : Windows 11 Pro</p>
                <p><b>Weight</b>: 1.4 kg</p>
                <p><b>Color</b>: grey</p>
            </div>
        </div>
    </div>
